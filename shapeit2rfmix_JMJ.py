...
parser = OptionParser()
parser.add_option('--shapeit_hap1', default=None)
...
parser.add_option('--shapeit_hap_admixed', default=None)

parser.add_option('--shapeit_sample1', default=None)
...
parser.add_option('--shapeit_sample_admixed', default=None)

parser.add_option('--ref_keep', default=None) #a list of individual IDs
...
parser.add_option('--chr', default=None)

parser.add_option('--genetic_map', default=None)
